...
* React is declarative, i.e., we describe **what** needs to happen instead of **how** to do it as in Javascript API. 
* There are two libraries we need to work with React in web: 
  * React: This library is the core library used to create components/elements.
  * ReactDOM: This library is used by React to interact with the DOM.
* `React.createElement()` : This is used to create an element. It takes three arguments: 
  * type: The type of element, such as 'div', 'span' etc.
  * props: Used to set the attributes and pass values intro the element.
  * children: Used to specify the children of the element. This can also be specified in props.
* `ReactDOM.render()` : This function is used to add our React element to the DOM. It takes two arguments, our element and the DOM element to insert our element in.
